...
* @Propósito: Proveer una implementación de una lista enlazada para gestionar 
*             elementos de tipo `Fleck`, incluyendo funcionalidades para añadir, 
*             eliminar, recorrer y liberar la lista. 
* @Fecha de creación: 15 de octubre de 2024
* @Última modificación: 4 de enero de 2025
* 
************************************************/

#ifndef _FLECK_LINKEDLIST_H_
#define _FLECK_LINKEDLIST_H_

#include <stdlib.h>
#include "types.h"

#define FLECK_LIST_NO_ERROR 0
#define FLECK_LIST_ERROR_FULL 1
#define FLECK_LIST_ERROR_EMPTY 2
#define FLECK_LIST_ERROR_MALLOC 3
#define FLECK_LIST_ERROR_END 4

typedef Fleck FleckElement;

typedef struct _FleckNode {
    FleckElement element;
    struct _FleckNode *next;
} FleckNode;
