...
* @Propósito: Proveer funciones para la gestión de listas enlazadas que contengan información de Workers, 
*             incluyendo creación, manipulación y destrucción de la lista y sus elementos.
* @Fecha de creación: 20 de octubre de 2024
* @Última modificación: 4 de enero de 2025
* 
************************************************/

#ifndef _WORKER_LINKEDLIST_H_
#define _WORKER_LINKEDLIST_H_

#include <stdlib.h>
#include "types.h"

#define WORKER_LIST_NO_ERROR 0
#define WORKER_LIST_ERROR_FULL 1
#define WORKER_LIST_ERROR_EMPTY 2
#define WORKER_LIST_ERROR_MALLOC 3
#define WORKER_LIST_ERROR_END 4
#define WORKER_LIST_ERROR_INDEX_OUT_OF_BOUNDS 5

typedef Worker WorkerElement;

typedef struct _WorkerNode {
    WorkerElement element;
    struct _WorkerNode *next;
} WorkerNode;
